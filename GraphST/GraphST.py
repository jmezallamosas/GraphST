...
class GraphST():
    def __init__(self, 
        ...
        batch_size : int, optional
            Batch size for training. The default is 5000.
        ...
        if 'adj' not in adata.obsm.keys():
           if self.datatype in ['Stereo', 'Slide']:
              ...
              construct_interaction(self.adata) # Use the updated function
    ...
    def train(self):
        ...
        num_batches = int(np.ceil(self.features.shape[0] / self.batch_size))
        ...
        for epoch in tqdm(range(self.epochs)):
            ...
            for batch in range(num_batches):
                ...
                end_idx = min((batch + 1) * self.batch_size, self.features.shape[0])
