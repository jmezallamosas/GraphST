...
def clustering(adata, n_clusters=7, radius=50, key='emb', method='mclust', start=0.1, end=3.0, increment=0.01, n_components=20, refinement=False):
    """\
    ...
    n_components : int, optional
        Value for PCA. The default is 20.
